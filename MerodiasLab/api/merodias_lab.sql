...
CREATE TABLE servicios (
  id                 BIGINT UNSIGNED NOT NULL AUTO_INCREMENT,
  identificador      VARCHAR(120)    NOT NULL,     -- equivalente a "slug"
  titulo             VARCHAR(160)    NOT NULL,
  descripcion        TEXT            NULL,
  horas_ayuno        TINYINT UNSIGNED NULL,        -- horas de ayuno sugeridas
  fecha_creacion     TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
  fecha_actualizacion TIMESTAMP NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (id),
...
CREATE TABLE resultados_citas (
  ...
  ruta_archivo   VARCHAR(500)    NOT NULL,   -- p.ej. /uploads/resultados/res_1730000000.pdf
  fecha_creacion TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (id),
...
-- Citas de ejemplo (usa el id correcto del paciente si cambias lo de arriba)
-- Para el ejemplo, usamos el último id insertado (el paciente “VILMA DIAZ”)
...
-- Si quieres asociar un resultado a una cita, descomenta y usa el id real:
